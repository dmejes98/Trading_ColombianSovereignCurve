...
class TESEnvTrade(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            df_total_value.to_csv('csv/trading/account_value_trade_{}_{}.csv'.format(self.model_name, self.iteration))
            ...
            print("previous_total_asset:{}".format(self.memoria_activos[0]))  
    ...
    def reset(self):
        ...
        # iteration += 1 
            ...
            self.memoria_activos = [previous_total_asset]
            #self.memoria_activos = [self.previous_state[0]]
            self.day = 0
            self.data = self.df.loc[self.day,:]
            self.turbulence = 0
            self.cost = 0
